...
const DATABRIDGE_CONTENT = {
  ...
  index: {
    ...
    pain_1_body:        "Your ops manager compiles and posts productivity data to Slack manually. Every day. Time that should be spent on decisions is spent on assembly.",
    ...
    l1_body:            "Structured productivity reports generated and pushed to Slack or email automatically — start of shift, mid-day, and end of day. Volume, headcount, speed, workflow metrics. No manual compilation, ever.",
    ...
    del_2: "Slack integration or email delivery for daily/shift reports",
    ...
    pricing_disclaimer: "No hidden fees. Build fee includes your first month of infrastructure hosting. After month 1, choose: our maintenance retainer ($300–500/month, hosting + support included), or transfer to your own infrastructure (~$5–10/month). All costs disclosed before you pay.",
  ...
  about: {
    ...
    stack_4_name:       "Slack / Email",
    stack_4_role:       "Delivery layer",
    stack_4_desc:       "Reports go where your team already works. No new dashboard to log into. No training required. The system fits around your workflow, not the other way around.",
